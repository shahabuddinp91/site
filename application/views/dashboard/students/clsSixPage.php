<section class="studentprofile" style="margin-top: 50px;">
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <?php echo anchor('Dashboard/classSixpdf',' Save as  ', array('class'=>'fa fa-file-pdf-o btn btn-primary savepdfbtn ','target'=>'_new'));?>
                <div class="panel panel-info">
                    <div class="panel-heading text-center">Total Students of Class Six in <?php echo date('Y'); ?></div>
                    <?php
